...
#         self.main_page.goto_hot().goto_hot_all_stocks().back().goto_hot_stock_one().back()\
...
#         self.main_page.goto_hot().goto_hot_all_topic().back().click_hot_topic_one()\
#             .back().click_hot_topic_two().back()
#
